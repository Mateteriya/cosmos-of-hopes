...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-3 sm:p-4 relative">
      ...
      {/* Кнопки переключения языков - в левом верхнем углу на всех устройствах */}
      <div className="fixed top-4 left-4 z-50 flex items-center gap-2 sm:gap-3" key={language}>
        <LanguageSwitcher />
        <AutoTranslator />
      </div>
