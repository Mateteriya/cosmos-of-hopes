...
var config = {
    ...
    hosts: {
        ...
        // authdomain: 'meet.super2026.online',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.meet.super2026.online',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'meet.super2026.online',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://meet.super2026.online/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    websocket: 'wss://meet.super2026.online/' + subdir + 'xmpp-websocket',

    // websocketKeepAliveUrl: 'https://meet.super2026.online/' + subdir + '_unlock',
    ...
    // focusUserJid: 'focus@auth.meet.super2026.online',

    // Option to send conference requests to jicofo over http (requires nginx rule for it)
    // conferenceRequestUrl:
    //   'https://<!--# echo var="http_host" default="meet.super2026.online" -->/' + subdir + 'conference-request/v1',
    ...
    //     // by default uses:
    //     // 'https://meet.super2026.online/static/oauth.html'
    //     redirectURI:
    //          'https://meet.super2026.online/subfolder/static/oauth.html',
    // },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.meet.super2026.online',
    ...
    */
    ...
    //     maxFileSize: 50,
    // },
    // Отключение P2P для стабильности соединения
    p2p: {
        enabled: false,
        stunServers: [
